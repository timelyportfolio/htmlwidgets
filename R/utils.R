...
#'
#' This function allows a widget to be embedded in a static Rmd document as an iframe.
...
#'
#' Note that the iframe will not be visible in the RStudio viewer, when
#' \code{selfcontained} is set to \code{TRUE}.
#'
